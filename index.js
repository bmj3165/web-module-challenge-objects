...
function createMenuItem(food, amt, index){
  const menuItem ={
    name: food,
    price: amt,
    category: index,
...
console.log(createMenuItem('ramen', 10, 'Lunch'));
...
*/
reviews.push('Brooke', 5, 'The food was okay');
      console.log(reviews);
...
reviews.push(0,0,'this place is chill with ');
